...
rf_df = d[, c("modelcondition", "startle_rf", "cassg_rf", "problin_rf", "nj_rf")]
...
require(gridExtra)
pdf("sim_tlscl_allsamples.pdf", width=10, height=5)
...
#wp_df = d[, c("modelcondition", "scaled2_startle_wp", "scaled2_cassg_wp", "scaled2_cassilp_wp", "scaled2_problin_wp", "scaled2_nj_wp")]
#head(wp_df)
#df2 <- melt(wp_df)
#head(df2)
