...
with open(fname, "w+") as f:
    ...
    for k in ks:
        ...
        for rep in range(int(reps)):
            dirname = "mlparsprob_results_k" + str(k) + "/rep" + str(rep)
            # print(dirname)
            if rep % 100 == 0:
            ...
            for bidx, estb in enumerate(est_branches):
                ...
                f.write("ML_parsprob\t" + str(k) + "\t" + str(rep) + "\t" + str(top_topoidx) + "\t" + str(bidx) + "\t" + str(true_branches[bidx]) + "\t" + str(estb) + "\n")
                f.flush()
